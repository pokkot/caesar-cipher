...
<form action="handler.php" method="post" class="upload-form" enctype="multipart/form-data">
    ...
    <textarea name="plain-text" id="plain-text" cols="60" rows="10"><? echo $_SESSION['caesar_input'] ?? 'Hello, world!' ?></textarea>

    <label for="filename">...or upload text file:</label>
    <input type="file" id="file" name="file" accept="text/plain">

    <label for="key">Encryption key:</label>
    <input type="number" name="key" id="key" value="<? echo $_SESSION['caesar_key'] ?? '3' ?>">
...
<div id="result">
    ...
    <textarea name="cipher" id="cipher" cols="60" rows="10"><? echo $_SESSION['caesar_output'] ?? '' ?></textarea>
</div>
