...
<div class="row">
    <div id="main" class="column">
        ...
        <div id="result">
            ...
            <input name="res" id="res" value="<? echo $_SESSION['bsgs_result'] ?? '' ?>" type="number">
        </div>
    </div>
    ...
    <div id="side" class="column">
        <div id="log">
            ...
            <textarea name="log" id="log" cols="50" rows="30"><? if ($_SESSION['bsgs_log']) foreach ($_SESSION['bsgs_log'] as $log) { echo $log."\n"; } ?></textarea>
        </div>
    </div>
</div>
